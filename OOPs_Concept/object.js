...
const cafe=function(order,price){
    this.order=order
    this.price=price
}
// const person1=new cafe("Pizza",250)
// console.log(person1);

cafe.prototype.increament=function(){
    this.price+=10
    console.log(this.price);    
}

cafe.prototype.placeOrder=function(){
    console.log(`The person has ordered: ${this.order}`);    
}

const person1=new cafe("Pizza",250)
const person2=new cafe("Burger",100)
